...
export default function AboutMePage() {
  return (
    <>
      <div className=" px-4">
        <div className="mx-auto max-w-5xl pb-32 pt-12">
          ...
          <div className="mx-auto max-w-4xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="flex w-full max-w-xl flex-col gap-y-6 border-4 border-black p-4 font-light dark:border-white sm:p-12 lg:shrink-0 xl:max-w-xl">
              <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
                JETHROGRAFIE?
              </h1>
              <p className="text-xl font-normal">
                YES, MIJN NAAM IS <span className="font-bold">JETHRO</span> EN
      ...
      {/* background stains - start */}
      <div
        className="absolute left-1/2 right-0 top-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl dark:opacity-60 lg:ml-16 xl:ml-20"
        aria-hidden="true"
      >
        <div
          className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#e2a8a8] to-[#8d6fe7] opacity-30"
